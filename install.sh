...
check_token() {
  echo -e "                                                       "
  echo -e "${RED}[+] =============================================== [+]${NC}"
  echo -e "${RED}[+]             LISENCE BY REYZXDZZCODE               [+]${NC}"
  echo -e "${RED}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "reyzsudahsembuh" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu wkww Ke ReyzXdzzCode Telegram @reyzxdzz${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "                                                       "
echo -e "${RED}╔╦╦╦╦╦╦╦╦╦╦╗                               ${NC}"
echo -e "${RED}╠╬╬╬╬╬╬╬╬╬╬╣       Auto Installer ReyzXdzzCode ${NC}"
echo -e "${RED}╠╬╬█╬╬╬╬█╬╬╣       ======================= ${NC}"
echo -e "${RED}╠╬╬╬╬╬╬╬╬╬╬╣        Support By ReyzXdzzCode   ${NC}"
echo -e "${RED}╠╬████████╬╣         Tele : @reyzxdzz       ${NC}"
echo -e "${RED}╠╬█╬╬╬╬╬╬█╬╣         Wa : s.id/reyzxdzzcode        ${NC}"
echo -e "${RED}╚╩╩╩╩╩╩╩╩╩╩╝                              ${NC}"
  echo -e "                                                       "
