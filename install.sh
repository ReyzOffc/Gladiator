...
check_token() {
  ...
  if [ "$USER_TOKEN" = "reyzsudahsembuh" ]; then
    echo -e "${GREEN}Succesfully Acces${NC}}"
  else
    echo -e "${GREEN}Silahkan Buy Terlebih Dahulu Di ReyzXdzzCode${NC}"
    echo -e "${YELLOW}TELEGRAM : @reyzxdzz${NC}"
    echo -e "${YELLOW}WHATSAPP : s.id/reyzxdzzcode${NC}"
...
while true; do
  ...
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by ReyzXdzzCode  ${NC}"
